...
xstart=c(S1=9,L1=0,I1=1,E1=0,R1=0,dr1=0,Id1=0, U1=50,Iep1=0,Ipb1=0,Ib1=0,df1=0)					#beginning population size
...
SIR.model=function(t,x,params){
  ...
  dL=(b*S*Iep*pep*tep+b*S*Ipb*ppb*tpb+b1*S*Ib*pb*tb)-sigma*L-mu*L  #infection of host, not yet infectious
...
times=seq(1,30,by=0.3)					#time steps to output
xstart=c(S=9,L=0,I=1,E=0,R=0,dr=0,Id=0, U=50,Iep=0,Ipb=0,Ib=0,df=0)					#beginning population size
...
title(main="Host Dynamics with Mouse Blood Infected Fleas, 9UH1IH 50UF LD50 of 1 CFU")
dev.off()
#rat plot;
...
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1, 5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Host Dynamics with Rat Blood Infected Fleas, 9UH1IH 50UF LD50 of 1 CFU")
dev.off()
...
plot(time,U1,ylab="Abundance",xlab="Time",type="l",col="forestgreen",lwd=2,ylim=c(0,max(50)),lty=1)
...
title(main="Flea Dynamics with Mouse Blood Infected Fleas, 9UH1IH 50UF LD50 of 1 CFU")
dev.off()
#rat plot;
...
plot(time,U,ylab="Abundance",xlab="Time",type="l",col="forestgreen",lwd=2,ylim=c(0,max(50)),lty=1)
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Rat Blood Infected Fleas, 9UH1IH 50UF LD50 of 1 CFU")
dev.off()
...
lines(time,Id1,col="black",lwd=2,lty=1)
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1,5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp =1)
title(main="Host Dynamics with Mouse Blood Infected Fleas, 9UH1IH 50UF LD50 of 10 CFU")
dev.off()
#rat plot;
...
lines(time,Id,col="black",lwd=2,lty=1)
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1,5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Host Dynamics with Rat Blood Infected Fleas, 9UH1IH 50UF LD50 of 10 CFU")
dev.off()
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Mouse Blood Infected Fleas, 9UH1IH 50UF LD50 of 10 CFU")
dev.off()
#rat plot;
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Rat Blood Infected Fleas, 9UH1IH 50UF LD50 of 10 CFU")
dev.off()
...
lines(time,Id1,col="black",lwd=2,lty=1)
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1,5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp =1)
title(main="Host Dynamics with Mouse Blood Infected Fleas, 9UH1IH 50UF LD50 of 100 CFU")
dev.off()
#rat plot;
...
lines(time,Id,col="black",lwd=2,lty=1)
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1,5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Host Dynamics with Rat Blood Infected Fleas, 9UH1IH 50UF LD50 of 100 CFU")
dev.off()
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Mouse Blood Infected Fleas, 9UH1IH 50UF LD50 of 100 CFU")
dev.off()
#rat plot;
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Rat Blood Infected Fleas, 9UH1IH 50UF LD50 of 100 CFU")
dev.off()
