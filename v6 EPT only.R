...
parms=c(alpha=1,lambdaA=0.04,lambdaB=0.20,lambdaC=0.07,b=0.4,b1=2,tau=0.39, muf=0.02, mupb=0.14,mub=0.20,
        pep=0.3,ppb=0,pb=0, tep=1, tpb=0, tb=0, 
...
parms=c(alpha=1,lambdaA=0.04,lambdaB=0.02,lambdaC=0.06,b=0.4,b1=2,tau=0.48, muf=0.02, mupb=0.13,mub=0.26,
        pep=1.0,ppb=0,pb=0,tep=1, tpb=0 , tb=0 ,
        mu=0.002,sigma=0.25,gamma=0.14,epsilon=0.5)	#set parameter values
out=lsoda(xstart, times, SIR.model, parms)  #run the model
...
title(main="Host Dynamics with Mouse Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 1 CFU  v6")
dev.off()
#rat plot;
...
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1, 5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Host Dynamics with Rat Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 1 CFU v6")
dev.off()
...
title(main="Flea Dynamics with Mouse Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 1 CFU v6")
dev.off()
#rat plot;
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Rat Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 1 CFU v6")
dev.off()
...
xstart=c(S=9,L=0,I=1,E=0,R=0,dr=0,Id=0, U=100,Iep=0,Ipb=0,Ib=0,df=0)					#beginning population size
parms=c(alpha=1,lambdaA=0.04,lambdaB=0.20,lambdaC=0.07,b=0.4,b1=2,tau=0.39, muf=0.02, mupb=0.14,mub=0.20,
        pep=0.3,ppb=0,pb=0, tep=0.01, tpb=0, tb=0, 
        mu=0.002,sigma=0.25,gamma=0.14,epsilon=0.5)	#set parameter values
out=lsoda(xstart, times, SIR.model, parms)  #run the model
...
lines(time,Id1,col="black",lwd=2,lty=1)
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1,5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp =1)
title(main="Host Dynamics with Mouse Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 10 CFU v6")
dev.off()
#rat plot;
...
lines(time,Id,col="black",lwd=2,lty=1)
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1,5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Host Dynamics with Rat Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 10 CFU v6")
dev.off()
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Mouse Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 10 CFU v6")
dev.off()
#rat plot;
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Rat Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 10 CFU v6")
dev.off()
...
xstart=c(S=9,L=0,I=1,E=0,R=0,dr=0,Id=0, U=100,Iep=0,Ipb=0,Ib=0,df=0)					#beginning population size
parms=c(alpha=1,lambdaA=0.04,lambdaB=0.20,lambdaC=0.07,b=0.4,b1=2,tau=0.39, muf=0.02, mupb=0.14,mub=0.20,
        pep=0.3,ppb=0,pb=0, tep=0.00, tpb=0, tb=0, 
        mu=0.002,sigma=0.25,gamma=0.14,epsilon=0.5)	#set parameter values
out=lsoda(xstart, times, SIR.model, parms)  #run the model
...
xstart=c(S=9,L=0,I=1,E=0,R=0,dr=0,Id=0, U=100,Iep=0,Ipb=0,Ib=0,df=0)					#beginning population size
parms=c(alpha=1,lambdaA=0.04,lambdaB=0.02,lambdaC=0.06,b=0.4,b1=2,tau=0.48, muf=0.02, mupb=0.13,mub=0.26,
        pep=1.0,ppb=0,pb=0,tep=0.1, tpb=0 , tb=0 ,
        mu=0.002,sigma=0.25,gamma=0.14,epsilon=0.5)	#set parameter values
out=lsoda(xstart, times, SIR.model, parms)  #run the model
...
lines(time,Id1,col="black",lwd=2,lty=1)
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1,5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp =1)
title(main="Host Dynamics with Mouse Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 100 CFU v6")
dev.off()
#rat plot;
...
lines(time,Id,col="black",lwd=2,lty=1)
legend(23,10,c("Susceptible", "Latent", "Infectious","Exposed", "Recovered", "Infected-dead"),col=c("forestgreen","red", "red","blue", "blue", "black"),bty="n",lty=c(1,5, 1, 1, 5, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Host Dynamics with Rat Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 100 CFU v6")
dev.off()
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Mouse Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 100 CFU v6")
dev.off()
#rat plot;
...
legend(20,50,c("Uninfected", "Infectious-Early Phase", "Infectious-Partially Blocked","Infectious-Fully Blocked", "Cumulative Dead"),
       col=c("forestgreen","blue", "red","red", "black"),bty="n",lty=c(1,1, 5, 1, 1),lwd=2,seg.len=2.0,x.intersp = 0.5, y.intersp = 1)
title(main="Flea Dynamics with Rat Blood Infected Fleas, 9UH1IH 100UF EPT only LD50 of 100 CFU v6")
dev.off()
